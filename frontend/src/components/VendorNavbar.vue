...
const menuItems = [
  { path: '/vendor/dashboard', icon: 'pi pi-home', label: 'Dashboard' },
  { path: '/vendor/menu-management', icon: 'pi pi-list', label: 'Menu Management' },
  { path: '/vendor/orders', icon: 'pi pi-shopping-cart', label: 'Orders' },
  { path: '/vendor/analytics', icon: 'pi pi-chart-line', label: 'Analytics' },
  { path: '/vendor/feedbacks', icon: 'pi pi-comments', label: 'Feedbacks' }
];
        ...
        <div class="px-4 py-4 border-b border-gray-200">
          <div class="grid grid-cols-2 gap-4">
            <div class="bg-green-50 p-3 rounded-lg">
              ...
              <p class="text-lg font-semibold text-primary">24</p>
            </div>
            <div class="bg-green-50 p-3 rounded-lg">
              <p class="text-xs text-gray-500">Revenue</p>
              <p class="text-lg font-semibold text-primary">$342</p>
            </div>
          </div>
        </div>

        <!-- Navigation Links -->
        <nav class="flex-1 px-3 py-4 space-y-1 bg-white overflow-y-auto">
          <RouterLink
